                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="3">
                                 <input type="text" name="Nombre" class="form-control infoemprendedor"  value="{{ Auth::user()->name }}">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                               <div class="form-group ">
                                    <select class="form-control col-sm-5" id="" name="Sexo" value="{{ old('Sexo') }}">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                  <div class="form-group ">
                                    <select class="form-control col-sm-5" id="" name="EstadoCivil" value="{{ old('EstadoCivil') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                 <input type="email" name="Correo" class="form-control infoemprendedor" value="{{ Auth::user()->email }}">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="form-group ">
                                    <select class="form-control col-sm-5" name="Escolaridad" value="{{ old('Escolaridad') }}">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                  <div class="form-group ">
                                    <select class="form-control col-sm-5" id="TipoPersona" name="TipoPersona" value="{{ old('TipoPersona') }}">
