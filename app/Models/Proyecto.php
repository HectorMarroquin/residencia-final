...
class Proyecto extends Model
{
    ...
    protected $fillable = ['Actividad','Razonsocial', 'RFC', 'NombreDirector', 'Telefonoemp', 'CorreoEmp', 'Propuesta', 'PropuestaOtra', 'NombreProd', 'Descripcion', 'Organizacion', 'Cual', 'asesor_id', 'emprendedor_id','Estado', 'created_at', 'updated_at'];
