...
$(document).ready(function () {
  $("#btnNuevointegrante").click(function () {
    ...
    if (i < 6) {
      ...
      Swal.fire('Solo puedes agregar 5 integrantes!', 'Clic en el boton!', 'warning');
    }
  });
  ...
  $("#compet").click(function () {
    ...
    if (b < 10) {
      ...
      Swal.fire('Solo puedes agregar 10 Competencia!', 'Clic en el boton!', 'warning');
    }
  });
  ...
  $("#client-pot").click(function () {
    ...
    if (a < 10) {
      ...
      Swal.fire('Solo puedes agregar 10 Clientes Potenciales!', 'Clic en el boton!', 'warning');
    }
  });
